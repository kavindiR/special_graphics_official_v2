...
const getImageUrl = (id: number, keyword: string) => {
  return `https://picsum.photos/seed/inspiration-${keyword}-${id}/800/600`;
};
...
const initialDesigns: Design[] = [
  ...
  { 
    ...
    image: getImageUrl(8, 'abstract'), isLiked: true 
  }
];
        ...
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
            ...
            <div className="relative max-w-7xl max-h-[90vh] w-full h-full flex items-center justify-center">
                 <img 
                    ...
                    className="max-w-full max-h-[90vh] w-auto h-auto object-contain object-center" 
                    onError={(e) => {
                        const target = e.target as HTMLImageElement;
                        target.src = `https://picsum.photos/1200/900?random=${selectedDesign.id}`;
                    }}
                 />
            </div>
        </div>
                            ...
                            <div className="w-full h-72 bg-gray-100 rounded-sm relative overflow-hidden shadow-sm hover:shadow-md transition-all">
                                {design.image ? (
                                    <img 
                                        ...
                                        onError={(e) => {
                                            const target = e.target as HTMLImageElement;
                                            target.src = `https://picsum.photos/800/600?random=${design.id}`;
                                        }}
                                    />
                                ) : (
                        ...
                        <div className="relative cursor-zoom-in shadow-2xl transition-transform duration-300 hover:scale-[1.01]" onClick={() => setIsFullScreen(true)}>
                            {selectedDesign.image ? (
                                 <img 
                                    src={selectedDesign.image} 
                                    alt={selectedDesign.title} 
                                    className="max-w-full max-h-[600px] w-auto h-auto object-contain object-center block" 
                                    loading="lazy"
                                    onError={(e) => {
                                        const target = e.target as HTMLImageElement;
                                        target.src = `https://picsum.photos/800/600?random=${selectedDesign.id}`;
                                    }}
                                 />
                            ) : (
